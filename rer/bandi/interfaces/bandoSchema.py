...
class IBandoSchema(model.Schema):
    ...
    directives.order_after(riferimenti_bando='IRichText.text')
    ...
    directives.order_after(chiusura_procedimento_bando='IRichText.text')
    ...
    directives.order_after(scadenza_bando='IRichText.text')
    ...
    directives.order_after(ente_bando='IRichText.text')
    ...
    directives.order_after(destinatari='IRichText.text')
    ...
    directives.order_after(tipologia_bando='IRichText.text')
